...
<div class="wrapper">
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="#"><i class="fas fa-address-card"></i>Members</a></li>
            <li><a href="#"><i class="fas fa-project-diagram"></i>Orders</a></li>
            <li><a href="#"><i class="fas fa-blog"></i>Bookings</a></li>
            <li><a href="#"><i class="fas fa-address-book"></i>Sports</a></li>
